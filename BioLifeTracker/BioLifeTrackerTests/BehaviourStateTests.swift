...
class BehaviourStateTests: XCTestCase {
    ...
    func testUpdates() {
        ...
        XCTAssert(state.name == "Fighting", "BehaviourState not initialised properly")
        
        XCTAssert(state.information == "Small claws bringing food to mouth", "BehaviourState not initialised properly")
        state.updateInformation("Engagement of large clawa with another crab")
        XCTAssert(state.information == "Engagement of large clawa with another crab", "BehaviourState not initialised properly")
        ...
        XCTAssert(state.photoUrls[0] == "www.photo1.com", "Individual not initialised properly")
        
        state.addPhotoUrl("www.photo2.com")
        XCTAssert(state.photoUrls[1] == "www.photo2.com", "Individual not initialised properly")
        
        state.removePhotoUrlAtIndex(0)
        XCTAssert(state.photoUrls[0] == "www.photo2.com", "Individual not initialised properly")
    }
